...
(4, 0, 'zhuang8026', '7c4a8d09ca3762af61e59520943dc26494f8941b', '快樂動起來', 'user01.jpg', '2021-04-28 16:58:45'),
(5, 0, 'wi001', 'b86beaf73419d6316cdc98d5b64ff19b21d603bb', 'wi001', NULL, '2021-05-13 10:16:41'),
...
INSERT INTO `penDetail` (`pId`, `penId`, `penStar`, `penImg`, `penTitle`, `created_at`, `updated_at`) VALUES
(1, 'P00001', 5, 'js.jpg', 'JS基本觀念：call by value 還是reference 又或是 sharing?', '2020-11-30 18:25:11', '2020-12-02 16:26:57'),
(2, 'P00002', 4, 'js.jpg', 'slice()、splice()、split() 傻傻分不清', '2020-11-30 18:25:11', '2020-12-01 16:21:46'),
(3, 'P00003', 4, 'js.jpg', 'push()、pop()、shfit()、unshfit() 到底是什麼？', '2020-11-30 18:25:11', '2020-12-01 16:21:46'),
(4, 'P00004', 3, 'js.jpg', 'target  &  currentTarget 差别', '2020-11-30 18:25:11', '2020-12-01 18:29:15'),
(5, 'P00005', 3, 'js.jpg', 'object.assign(target, source) 合併多個對象', '2020-11-30 18:25:11', '2020-12-01 18:29:15'),
(6, 'P00006', 5, 'js.jpg', 'Array function 大全', '2020-11-30 18:25:11', '2020-12-01 18:29:15'),
(7, 'P00007', 5, 'js.jpg', 'for of & for in 差別', '2020-11-30 18:25:11', '2020-12-01 18:29:15'),
(8, 'P00008', 5, 'js.jpg', 'append & appendChild & innerHtml 差別', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(9, 'P00009', 5, 'js.jpg', 'charCodeAt () & charAt() 差別', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(10, 'P00010', 5, 'js.jpg', 'sort() 排序', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(11, 'P00011', 5, 'js.jpg', 'replace( ) 字符串替换', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(12, 'P00012', 5, 'js.jpg', 'decodeURIComponent() & encodeURIComponent() 加碼 解碼', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(13, 'P00013', 5, 'js.jpg', 'String( ) & toString( ) 差別', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(14, 'P00014', 5, 'js.jpg', 'parseInt() & parseFloat() & Number() 差別', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(15, 'P00015', 5, 'js.jpg', 'findOne( ) & find( ) 差別', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(16, 'P00016', 5, 'js.jpg', 'setInterval() & clearInterval() 無限循環 和 取消循環', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(17, 'P00017', 5, 'js.jpg', 'promise 回調函數 / 異步函數', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(18, 'P00018', 5, 'js.jpg', 'filter( ) 數組過濾', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(19, 'P00019', 5, 'js.jpg', 'map( ) 迴圈數組', '2020-11-30 18:25:11', '2020-12-01 19:07:09'),
(20, 'P00020', 5, 'js.jpg', 'some( ) 陣列條件篩選/部分符合', '2020-11-30 18:25:11', '2020-12-02 14:07:18'),
(21, 'P00021', 5, 'js.jpg', 'every( ) 陣列條件篩選/全部符合', '2020-11-30 18:25:11', '2020-12-02 14:07:18'),
(22, 'P00022', 5, 'js.jpg', 'reduce( ) 陣列累加器', '2020-11-30 18:25:11', '2020-12-02 14:07:18'),
(23, 'P00023', 4, 'js.jpg', '深拷貝和淺拷貝 - 有哪些？', '2021-04-20 16:41:57', '2021-04-20 16:41:57');
...
--
ALTER TABLE `penBlock`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水編號', AUTO_INCREMENT=42;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `penDetail`
--
ALTER TABLE `penDetail`
  MODIFY `pId` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水編號', AUTO_INCREMENT=24;
COMMIT;
